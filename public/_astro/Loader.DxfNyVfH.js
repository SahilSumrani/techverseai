...
const i = s => {
        ...
        return e.jsx("div", {
            className: t("bg-bor-dark/80 dark fixed inset-0 h-full w-full", a),
            ...r
        })
    },
    o = s => {
        ...
        return e.jsx("div", {
            "data-testid": "loader",
            className: t("text-bor-primary bg-bor-tertiary-100 flex h-24 w-24 items-center justify-center rounded-2xl p-1", a),
            children: e.jsx("svg", {
                width: "96",
                height: "96",
                viewBox: "0 0 96 96",
    ...
    m = s => {
        ...
        return a ? e.jsx(i, {
            className: t("animate-fade-in z-999999999 cursor-wait", r),
            ...l,
            children: e.jsx(o, {
                className: "animate-fade-in absolute inset-0 m-auto"
            })
        }) : e.jsx(o, { ...l
        })
    };
