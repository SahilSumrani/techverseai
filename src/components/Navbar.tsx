...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="relative flex justify-center items-center py-3 bg-transparent z-40" style={{ fontFamily: 'Matter, sans-serif' }}>
      ...
      <div className="hidden md:grid grid-cols-3 items-center rounded-full px-8 py-2 border border-gray-200 min-w-[750px] max-w-[900px] bg-white/95 backdrop-blur-md shadow-sm">
        ...
        <div className="flex justify-center items-center">
          <a href="/" className="flex items-center justify-center">
            <img src="/logo.png" alt="Techverse Logo" className="h-16 md:h-20 lg:h-24 w-auto object-contain transition-transform hover:scale-105" />
          </a>
        </div>
        <div className="flex justify-center space-x-8">
      ...
      <div className="flex md:hidden w-[94%] max-w-[440px] justify-between items-center px-4 sm:px-5 py-2 border border-gray-200 rounded-full bg-white/95 backdrop-blur-md shadow-sm z-50">
        <a href="/" className="flex items-center">
          <img src="/logo.png" alt="Techverse Logo" className="h-14 sm:h-16 w-auto object-contain" />
        </a>
        <button
